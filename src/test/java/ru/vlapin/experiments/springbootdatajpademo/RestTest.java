...
public class RestTest {
  ...
  @BeforeEach
  void setUp() {
    flightRepository.save(Flight.builder().origin("Madrid").build());
    flightRepository.save(Flight.builder().origin("London").build());
    flightRepository.save(Flight.builder().origin("Paris").build());
  }

  @Test
  @SneakyThrows
  @DisplayName("Rest Repository works correctly")
  void restRepositoryWorksCorrectlyTest() {
